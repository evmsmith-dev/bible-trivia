...
- Runtime cache version: `bible-trivia-cache-v1.9.107` (`service-worker.js`)
- Package version: `1.9.107` (`package.json`)
...
Current cache version: `bible-trivia-cache-v1.9.107`.
